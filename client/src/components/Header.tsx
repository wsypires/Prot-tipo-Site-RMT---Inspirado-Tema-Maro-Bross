      ...
      <div className="relative h-full container flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-2 btn-mario yellow"
            title="Ir para Marketplace"
          >
            <ShoppingCart size={16} />
            <span className="hidden md:inline text-xs">LOJA</span>
          </button>

          {/* Chat Button */}
          <button 
            onClick={() => setLocation("/chat")}
            className="hidden sm:flex items-center gap-2 btn-mario blue"
            title="Ir para Chat"
          >
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-2 btn-mario green"
            title="Notificações"
          >
            <Bell size={16} />
            <span className="hidden md:inline text-xs">AVISOS</span>
          </button>
